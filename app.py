...
def ai_chat():
    ...
    system_prompt = (
        ...
        "   Example: \"🌿 **Your Lawn Guide**\"\n\n"
        "2. SECTIONS: Break content into clear sections using ═══ dividers.\n"
        "   Sections should each have a bold emoji heading.\n\n"
        "3. LISTS: Use bullet points (•) for features, steps, or options.\n\n"
